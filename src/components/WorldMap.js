...
class WorldMap extends Component {
  ...
  isCountryLived = (countryCode) =>
    _.includes(this.countriesLived, countryCode);

  /**
   * Was a country visited
   */
  isCountryVisited = (countryCode) =>
    _.includes(this.countriesVisited, countryCode);
  ...
  isImportantCountry = (countryCode) =>
    this.isCountryLived(countryCode) || this.isCountryVisited(countryCode);
